    ...
    def print_profit_pos_report(self):
        ...
        for session in sessions:
            ...
            for transaction in transactions:
                ...
                pick_name = transaction.picking_id.name
                ...
                index = 0
                _logger.warning(transaction.name)
                for line in transaction.lines:
                    _logger.warning(index)
                    name = line.product_id.name
                    debit = 0
                    if name != 'Biaya Pengiriman':
                        debit = journals[index].line_ids[1].debit
                        index += 1
